...
def itp(atoms, Box=None, file_path=None, molecule_name=None, nrexcl=1, comment=None, 
    ...
    with open(file_path, 'w') as f:
        ...
        f.write(f"; Total charge of the system is {total_charge:.8f}\n")
...
def psf(atoms, Box=None, file_path=None, segid=None, rmaxH=1.2, rmaxM=2.45, 
    ...
    with open(file_path, 'w') as f:
        ...
        f.write(f" REMARKS Total charge of the system is {total_charge:.8f}\n")
        if bimodal_info:
        ...
        for i, atom in enumerate(atoms, 1):
            ...
            f.write(f"{i:8d} {segid:4s} {res_nr:4d} {res_name:4s} {at_name:4s} {at_type:4s} {charge:10.8f} {mass:10.4f} 0\n")
...
def lmp(atoms, Box=None, file_path=None, forcefield=None, rmaxH=1.2, rmaxM=2.45, 
    ...
    total_charge = round(total_charge, 8)
    print(f"write_lmp: Total charge: {total_charge:.8f}")
    ...
    with open(file_path, 'w') as f:
        ...
        for i, atom in enumerate(atoms, 1):
            ...
            f.write(f"{i:<8}{molid:<8}{atom_type:<8}{charge:<12.8f}{x:<12.5f}{y:<12.5f}{z:<12.5f}  # {atom.get('type', '')}\n")
        f.write("\n")
