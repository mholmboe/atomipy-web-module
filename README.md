...
> **Note:** the **Simulate** node's **GROMACS** engine is **off by default** on
> Colab. Run the optional **Step 1c** cell in the notebook to install a
> **CUDA-enabled GROMACS** (via micromamba, no kernel restart) and put `gmx` on
