    ...
    <footer className="border-t border-border py-12 mt-12 bg-muted/30">
      <div className="container mx-auto px-6 text-center space-y-4">
        <div className="text-sm text-muted-foreground">
          Based on <a href="https://github.com/mholmboe/atomipy" className="text-primary hover:underline font-medium" target="_blank" rel="noopener noreferrer">atomipy</a> — Mineral-based MD simulation tools
        </div>
